                ...
                for (var i = 0; i < PathsArray[index].Length; i++)
                {
                    ...
                    if (transform.position != target2.position)
                    {
                        ...
                        while (transform.position != target1.position)
                        {
                            ...
                            transform.position = Vector3.MoveTowards(transform.position, target1.position, speed * speedMultiplier * Time.deltaTime);
                            yield return null;
                        }
                    ...
                    while (transform.position != target2.position)
                    {
                        ...
                        //this.transform.rotation = Quaternion.LookRotation(Vector3.RotateTowards(transform.forward, targetDirection, Speed * Time.deltaTime, 0.0f));
                        transform.rotation = Quaternion.LookRotation(targetDirection);
                        transform.position = Vector3.MoveTowards(transform.position, target2.position, speed * speedMultiplier * Time.deltaTime);
                        yield return null;
                    }
                    //invert targets
